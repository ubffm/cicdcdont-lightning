			...
			\begin{varwidth}{\linewidth}
				\begin{itemize}
					...
					\begin{itemize}
						...
						\item using hardware security modules
					\end{itemize}
				\end{itemize}
			\end{varwidth}
		},
		...
		label={[align=right]right:%
			\begin{varwidth}{\linewidth}
				\begin{itemize}
					\item Privilege Separation:
					\begin{itemize}
						\item enforced offsite/offline backups
					\end{itemize}
					\item Signing of commits \\
						and checking the signatures
				\end{itemize}
		...
		label={[align=right]right:%
			\begin{varwidth}{\linewidth}
				\begin{itemize}
					...
					\begin{itemize}
						\item enforced offsite/offline backups
						\item splitting the infrastructure in groups
						\item regular self checks/deploys
					\end{itemize}
				\end{itemize}
			\end{varwidth}
		},
